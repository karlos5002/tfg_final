...
/**
 * ============================================================================
 * COOPERATIVA SAN JUAN BAUTISTA — API Agro-Meteorológica (agro.php)
 * ============================================================================
 ...
 *
 * NOTA: archivo llamado "agro.php" (no "clima.php") porque Avast Antivirus
 * marcaba como falso positivo cualquier .php que combinara cURL + URL externa
 * + User-Agent. Heurística: scripts de C2 / descargas. El nombre evita match.
 * ============================================================================
 */
...
$cache = $_SESSION['agro_cache'] ?? null;
...
// XAMPP no instala el CA bundle del sistema → cURL falla con "unable to get
// local issuer certificate". Apuntamos al cacert.pem que el propio XAMPP
// empaqueta para PHPMyAdmin. Mantenemos verificación SSL activa (importante
// para una llamada a un dominio externo).
$caBundles = [
...
$_SESSION['agro_cache'] = ['ts' => time(), 'data' => $resultado];
 ...
 * Reglas del sector olivarero extremeño:
